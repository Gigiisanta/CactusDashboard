...
class CactusService:
    ...
    def get_idea_by_id(self, idea_id: int) -> Optional[CactusIdeaRead]:
        """Get idea by ID."""
    ...
    def update_idea(self, idea_id: int, idea_data: CactusIdeaUpdate, user_id: int) -> Optional[CactusIdeaRead]:
    ...
    def move_idea_to_status(self, idea_id: int, new_status: str, user_id: int) -> Optional[CactusIdeaRead]:
    ...
    def get_content_matrix_by_id(self, content_id: int) -> Optional[CactusContentMatrixRead]:
    ...
    def update_content_matrix(self, content_id: int, content_data: CactusContentMatrixUpdate, user_id: int) -> Optional[CactusContentMatrixRead]:
    ...
    def get_video_slot_by_id(self, video_id: int) -> Optional[CactusVideoSlotRead]:
    ...
    def update_video_slot(self, video_id: int, video_data: CactusVideoSlotUpdate, user_id: int) -> Optional[CactusVideoSlotRead]:
    ...
    def get_library_item_by_id(self, library_id: int) -> Optional[CactusLibraryRead]:
    ...
    def update_library_item(self, library_id: int, library_data: CactusLibraryUpdate, user_id: int) -> Optional[CactusLibraryRead]:
    ...
    def get_external_link_by_id(self, link_id: int) -> Optional[CactusExternalLinkRead]:
    ...
    def update_external_link(self, link_id: int, link_data: CactusExternalLinkUpdate, user_id: int) -> Optional[CactusExternalLinkRead]:
    ...
    def create_secure_credential(self, credential_data: CactusSecureCredentialCreate, user_id: int) -> Optional[CactusSecureCredentialRead]:
    ...
    def get_secure_credential_by_id(self, credential_id: int) -> Optional[CactusSecureCredentialRead]:
    ...
    def get_secure_credential_values(self, credential_id: int) -> Optional[CactusSecureCredentialValue]:
    ...
    def update_secure_credential(self, credential_id: int, credential_data: CactusSecureCredentialUpdate, user_id: int) -> Optional[CactusSecureCredentialRead]:
