...
class CactusRepository:
    ...
    def get_idea_by_id(self, idea_id: int) -> CactusIdea | None:
        """Get idea by ID."""
    ...
    def update_idea(self, idea_id: int, idea_data: dict[str, Any], user_id: int) -> CactusIdea | None:
    ...
    def get_content_matrix_by_id(self, content_id: int) -> CactusContentMatrix | None:
    ...
    def update_content_matrix(self, content_id: int, content_data: dict[str, Any], user_id: int) -> CactusContentMatrix | None:
    ...
    def get_video_slot_by_id(self, video_id: int) -> CactusVideoSlot | None:
    ...
    def update_video_slot(self, video_id: int, video_data: dict[str, Any], user_id: int) -> CactusVideoSlot | None:
    ...
    def get_library_item_by_id(self, library_id: int) -> CactusLibrary | None:
    ...
    def update_library_item(self, library_id: int, library_data: dict[str, Any], user_id: int) -> CactusLibrary | None:
    ...
    def get_external_link_by_id(self, link_id: int) -> CactusExternalLink | None:
    ...
    def get_active_external_links(self) -> list[CactusExternalLink]:
        ...
        statement = select(CactusExternalLink).where(
            CactusExternalLink.is_active is True
        ).order_by(CactusExternalLink.position)
        return list(self.session.exec(statement))

    def update_external_link(self, link_id: int, link_data: dict[str, Any], user_id: int) -> CactusExternalLink | None:
    ...
    def get_secure_credential_by_id(self, credential_id: int) -> CactusSecureCredential | None:
    ...
    def update_secure_credential(self, credential_id: int, credential_data: dict[str, Any], user_id: int) -> CactusSecureCredential | None:
